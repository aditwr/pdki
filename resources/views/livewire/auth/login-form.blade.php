<div class="p-8 bg-base-100 rounded-badge w-96">
    <div class="mb-6">
        <form wire:submit='login' action="">
            <h1 class="mb-4 text-2xl font-semibold text-center text-neutral/100">Login</h1>
            <div class="mb-2">
                <x-form.input-text name="email" wire:model.live="email" class="w-full input input-bordered input-ghost"
                    placeholder="Email" />
            </div>
            <div class="mb-2">
    ...
    <div class="mt-2">
        <span class="text-sm font-medium text-center min-w-fit text-neutral/60">Belum punya akun? <a
                href="{{ route('register') }}" class="font-medium text-primary">Daftar</a></span>
    </div>
    {{-- Sosialite Login --}}
    <div class="flex items-center justify-between my-4 space-x-3">
        <hr class="w-full my-4 border-neutral/20">
        <span class="text-sm font-medium text-center min-w-fit text-neutral/60">Login dengan</span>
        <hr class="w-full my-4 border-neutral/20">
    </div>
