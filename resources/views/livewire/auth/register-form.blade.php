<div class="p-8 bg-base-100 rounded-badge w-96">
    <div class="mb-6">
        <form wire:submit='register' action="">
            <h1 class="mb-4 text-2xl font-semibold text-center text-neutral/100">SignUp</h1>
            <div class="mb-2">
                <x-form.input-text name="name" wire:model.live="name" class="w-full input input-bordered input-ghost"
                    placeholder="Nama Lengkap" />
            </div>
            <div class="mb-2">
                <x-form.input-text name="email" wire:model.live="email"
                    class="w-full input input-bordered input-ghost" placeholder="Email" />
            </div>
            <div class="mb-2">
                <x-form.input-password name="password" wire:model.live="password"
                    class="w-full input input-bordered input-ghost" placeholder="Password" />
            </div>
            <div class="mb-2">
                <x-form.input-password name="confirm_password" wire:model.live="confirmPassword"
                    class="w-full input input-bordered input-ghost" placeholder="Konfirmasi Password" />
            </div>
            <button type="submit" class="w-full btn btn-primary">SignUp</button>
        </form>
    </div>
    {{-- Sosialite Login --}}
    <div class="flex items-center justify-between my-4 space-x-3">
        <hr class="w-full my-4 border-neutral/20">
        <span class="text-xs font-semibold text-center min-w-fit text-neutral/60">Sign Up dengan</span>
        <hr class="w-full my-4 border-neutral/20">
    </div>
    <div class="flex items-center justify-center mt-4 space-x-2">
        <a href="{{ route('socialite.redirect', 'google') }}" class="p-3 btn btn-ghost w-fit h-fit btn-circle">
        ...
        <a href="{{ route('socialite.redirect', 'github') }}" class="p-3 btn btn-ghost w-fit h-fit btn-circle">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" class="w-8 h-8" viewBox="0 0 48 48">
        ...
        <a href="{{ route('socialite.redirect', 'facebook') }}" class="p-3 btn btn-ghost w-fit h-fit btn-circle">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" class="w-8 h-8" viewBox="0 0 48 48">
