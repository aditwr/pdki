                ...
                <div class="flex items-baseline mb-4 gap-x-4">
                    <div class="">
                        <label class="mb-3 form-control">
                            ...
                            <input wire:model.live='tanggalAwal' id="" type="date"
                    ...
                    <div class="">
                        <label class="mb-3 form-control">
                            ...
                            <input wire:model.live='tanggalAkhir' id="" type="date"
                                class="input input-bordered" />
                        </label>
                    </div>
                    <div class="">
                        <label class="mb-3 form-control">
                            ...
                            <button wire:click='gunakanFilter' class="btn btn-neutral">Gunakan Filter</button>
                        </label>
                    </div>
                    <div class="">
                        <label class="mb-3 form-control">
                            ...
                            <button wire:click='resetFilter' class="btn btn-neutral">Reset Filter</button>
                        </label>
                    </div>
