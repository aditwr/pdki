...
@section('content')
    <div class="max-w-7xl">
        ...
        <div x-data="{
            ...
            {{-- Form --}}
            <form action="{{ route('permohonan.pendaftaran-merek.update', $pendaftaran_merek->no_permohonan) }}"
                method="POST">
                @csrf
                <input type="hidden" name="pendaftaran_merek" value="{{ $pendaftaran_merek }}">
                        ...
                        <div class="">
                            ...
                            <div class="">
                                <x-dashboard.form.text-input name="nama_merek" label="Nama Merek" placeholder="Nama Merek"
                                    value="{{ $pendaftaran_merek->nama_merek }}" containerClass="max-w-3xl" />
                            </div>
                            <div class="">
                                <x-dashboard.form.text-input name="translasi" label="Translasi Merek"
                                    value="{{ $pendaftaran_merek->translasi }}" placeholder="Translasi"
                                    containerClass="max-w-3xl" />
                            </div>
                            <div class="mb-3">
                                <x-dashboard.form.textarea name="jenis_barang_jasa" label="Jenis Barang atau Jasa"
                                    value="{{ $pendaftaran_merek->jenis_barang_jasa }}"
                            ...
                            <div class="mb-3">
                                <x-dashboard.form.select name="kelas_barang_jasa" label="Kategori Barang / Jasa"
                                    containerClass="" value="{{ $pendaftaran_merek->kelas_barang_jasa }}"
                                    :items="[
                                        '10' => 'Makanan',
                                        '20' => 'Minuman',
                                        '30' => 'Pakaian',
                        ...
                        <div class="">
                            <div class="">
                                <x-dashboard.form.text-input name="pemohon" label="Pemohon Pengajuan"
                                    ...
                                    value="{{ $pendaftaran_merek->pemohon }}" containerClass="max-w-3xl" />
                            </div>
                            <div class="">
                                <x-dashboard.form.textarea name="alamat_pemohon" label="Pemohon Pengajuan"
                                    placeholder="alamat perusahaan / personal yang mengajukan permohonan"
                                    value="{{ $pendaftaran_merek->alamat_pemohon }}" containerClass="max-w-3xl" />
                            </div>
                            <div class="flex gap-x-8">
                                <div class="w-72">
                                    <x-dashboard.form.text-input name="no_telepon_pemohon" label="Nomor Telepon Pemohon"
                                        placeholder="Nomor Telepon" value="{{ $pendaftaran_merek->no_telepon_pemohon }}"
                                        containerClass="" />
                                </div>
                                {{-- <div class="">
                                ...
                                <div x-data="{
                                    search: '{{ $pendaftaran_merek->kewarganegaraan_pemohon }}',
                                    ...
                                    <label class="w-full mb-3 form-control">
                                        ...
                                        <div class="relative">
                                            <input x-model="search" name="kewarganegaraan_pemohon"
                                                ...
                                                placeholder="Kewarganegaraan" class="w-full input input-bordered" />
                        ...
                        <div class="">
                            ...
                            <div class="">
                                <x-dashboard.form.text-input name="konsultan" label="Nama Konsultan"
                                    placeholder="Nama Konsultan" value="{{ $pendaftaran_merek->konsultan }}"
                                    containerClass="max-w-3xl" />
                            </div>
                            {{-- alamat konsultan --}}
                            <div class="">
                                <x-dashboard.form.textarea name="alamat_konsultan" label="Alamat Konsultan"
                                    placeholder="Alamat Konsultan" value="{{ $pendaftaran_merek->alamat_konsultan }}"
                                    containerClass="max-w-3xl" />
                            </div>
                            ...
                            <div class="flex gap-x-8">
                                <div class="w-72">
                                    <x-dashboard.form.text-input name="no_telepon_konsultan"
                                        label="Nomor Telepon Konsultan" placeholder="Nomor Telepon"
                                        value="{{ $pendaftaran_merek->no_telepon_konsultan }}" containerClass="" />
                                </div>
                                {{-- Alpine Input Component --}}
                                <div x-data="{
                                    search: '{{ $pendaftaran_merek->kewarganegaraan_konsultan }}',
                                    items: {{ json_encode($countries) }},
                                    get filteredItems() {
                                        if (this.search === '') {
                                            return this.items;
